use crate::{
    action::SelectionAction::ExtendSelectionUp,
    mode::Mode,
...
#[test] fn with_mixed_valid_and_invalid_selections_block_semantics(){
    ...
    test_selection_action(
        ...
        "idk\nsome\nshit\n", 
        vec![
            Selection::new_unchecked(0..1, None, 0), //invalid
            Selection::new_unchecked(8..9, None, 4), //to shorter line
            Selection::new_unchecked(14..15, None, 0),   //common use
        ], 
        0, 
        1, 
        Mode::Insert, 
        vec![
            ...
            Selection::new_unchecked(3..9, Some(Direction::Backward), 4),
            Selection::new_unchecked(9..14, Some(Direction::Backward), 0),
        ], 
        0
    );
}
