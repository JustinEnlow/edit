...
impl SelectionAction{
    fn action_name(&self) -> String{
        let name = match self{
            ...
            SelectionAction::ExtendSelectionBufferStart => "extend selection buffer start",
            SelectionAction::ExtendSelectionBufferEnd => "extend selection buffer end",
            SelectionAction::ExtendSelectionPageUp => "extend selection page up",
            SelectionAction::ExtendSelectionPageDown => "extend selection page down",
