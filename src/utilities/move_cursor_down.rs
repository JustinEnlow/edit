...
fn selection_impl(selection: &Selection, count: usize, buffer: &crate::buffer::Buffer, display_area: Option<&DisplayArea>, semantics: CursorSemantics) -> Result<Selection, SelectionError>{
...
//    Ok(selection)
    selection.move_vertically(count, buffer, crate::selection::Movement::Move, ExtensionDirection::Forward, semantics)
}
