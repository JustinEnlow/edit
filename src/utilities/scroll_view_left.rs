...
mod tests{
    ...
    fn test(_semantics: CursorSemantics, text: &str, view: DisplayArea, amount: usize, expected_text: &str, expected_view: DisplayArea){
        ...
        let result = scroll_view_left::application_impl(&mut app, &view, amount);
    ...
    fn test_error(_semantics: CursorSemantics, text: &str, view: DisplayArea, amount: usize){
        ...
        assert!(scroll_view_left::application_impl(&mut app, &view, amount).is_err());
        assert!(!app.buffer.is_modified());
    }
    ...
    #[test] fn scroll_left(){
        test(
            ...
            "idk\nsome\nshit\n", 
            DisplayArea::new(1, 0, 2, 2), 1, 
            "id\nso\n", 
            DisplayArea::new(0, 0, 2, 2), 
        );
    }
