...
#[test] fn with_multiple_valid_selections_block_semantics(){
    ...
    test_selection_action(
        ...
        vec![
            ...
            Selection::new_unchecked(Range::new(11, 16), ExtensionDirection::Forward, None),
        ...
        vec![
            //(2, 3, Some(2)),
            Selection::new_unchecked(Range::new(2, 3), ExtensionDirection::None, Some(2)),
            //(8, 9, Some(8)),
            Selection::new_unchecked(Range::new(8, 9), ExtensionDirection::None, Some(8)),
            //(9, 10, Some(9)),
            Selection::new_unchecked(Range::new(9, 10), ExtensionDirection::None, Some(9)),
            //(16, 17, Some(16)),
            Selection::new_unchecked(Range::new(16, 17), ExtensionDirection::None, Some(16)),
            //(21, 22, Some(21))
            Selection::new_unchecked(Range::new(21, 22), ExtensionDirection::None, Some(21)),
        ], 
        0
    );
}
...
#[test] fn with_mixed_valid_and_invalid_selections_block_semantics(){
    test_selection_action(
        ...
        vec![
            //(7, 8, Some(3)),
            Selection::new_unchecked(Range::new(7, 8), ExtensionDirection::None, Some(3)),
            //(14, 15, None)
            Selection::new_unchecked(Range::new(14, 15), ExtensionDirection::None, None),
        ], 
        0
