        ...
        //block
            ...
            #[test] fn to_line_with_same_len_or_more_with_extended_selection_with_direction_forward(){
                ...
                test_selection_action(
                    ...
                    vec![
                        //(9, 13, None)
                        Selection::new_unchecked(Range::new(9, 13), ExtensionDirection::Forward, None),
                    ], 
                    0, 
                    1, 
                    Mode::Insert, 
            ...
            #[test] fn to_line_with_same_len_or_more_with_extended_selection_with_direction_backward(){
                ...
                test_selection_action(
                    ...
                    vec![
                        //(13, 9, None)
                        Selection::new_unchecked(Range::new(9, 13), ExtensionDirection::Backward, None),
                    ], 
                    0, 
                    1, 
                    Mode::Insert, 
                    vec![
                        //(8, 4, None),
                        Selection::new_unchecked(Range::new(4, 8), ExtensionDirection::Backward, None),
                        //(13, 9, None)
                        Selection::new_unchecked(Range::new(9, 13), ExtensionDirection::Backward, None),
                    ], 
                    1
        ...
        //block
            ...
            #[test] fn to_shorter_line_with_extended_selection_with_direction_forward(){
                ...
                test_selection_action(
                    ...
                    vec![
                        //(4, 9, None)
                        Selection::new_unchecked(Range::new(4, 9), ExtensionDirection::Forward, None),
                    ], 
                    0, 
                    1, 
                    Mode::Insert, 
            ...
            #[test] fn to_shorter_line_with_extended_selection_with_direction_backward(){
                ...
                test_selection_action(
                    ...
                    vec![
                        //(9, 4, None)
                        Selection::new_unchecked(Range::new(4, 9), ExtensionDirection::Backward, None),
                    ], 
                    0, 
                    1, 
                    Mode::Insert, 
                    vec![
                        //(4, 0, None),
                        Selection::new_unchecked(Range::new(0, 4), ExtensionDirection::Backward, None),
                        //(9, 4, None)
                        Selection::new_unchecked(Range::new(4, 9), ExtensionDirection::Backward, None),
                    ], 
                    1
        ...
        //block
            ...
            #[test] fn should_error_if_on_top_line_with_extended_selection_with_direction_backward(){
                ...
                test_selection_action(
                    ...
                    vec![
                        //(3, 0, None)
                        Selection::new_unchecked(Range::new(0, 3), ExtensionDirection::Backward, None),
                    ], 
                    0, 
                    1, 
                    match SAME_STATE_DISPLAY_MODE{
        ...
        //block
            ...
            #[test] fn should_error_if_any_selection_is_multiline_with_direction_forward(){
                test_selection_action(
                    ...
                    vec![
                        //(0, 9, None)
                        Selection::new_unchecked(Range::new(0, 9), ExtensionDirection::Forward, None),
                    ], 
                    0, 
                    1, 
                    match SAME_STATE_DISPLAY_MODE{
            ...
            #[test] fn should_error_if_any_selection_is_multiline_with_direction_backward(){
                test_selection_action(
                    ...
                    vec![
                        //(9, 0, None)
                        Selection::new_unchecked(Range::new(0, 9), ExtensionDirection::Backward, None),
                    ], 
                    0, 
                    1, 
                    match SAME_STATE_DISPLAY_MODE{
